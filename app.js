    ...
    if (post) {
        ...
        container.innerHTML = `
            <div class="error-message" style="text-align: center; padding: 40px;">
                ...
                <a href="index.html" class="btn btn-primary" style="padding: 14px 28px; background: linear-gradient(135deg, #6366f1, #0ea5e9); color: white; border-radius: 50px; font-weight: 600;">Go to Homepage</a>
            </div>
        `;
    }
}
